...
const PurchaseSuccessPage = () => {
    ...
    if (isProcessing) {
        return (
            <div className='h-screen flex items-center justify-center text-lg text-white'>
    ...
    return (
        ...
        <div className='h-screen flex items-center justify-center px-4 mt-24'>
            <Confetti width={dimensions.width}
            ...
            <div className='max-w-md w-full bg-gray-800 rounded-lg shadow-xl overflow-hidden relative z-10'>
                <div className='p-6 sm:p-8'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <Link href='/' className='w-full bg-gray-700 hover:bg-gray-600 text-emerald-400 font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center justify-center'>
                            Continue Shopping
